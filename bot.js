...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    this.res.writeHead(200);
    postMessage("http://daddyleagues.com/gridgreatness/rules");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/gridgreatness/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/gridgreatness/players?name="+rep+"&position=all&team=all");
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/spreadsheets/d/1HdxKWcN_EIUNUWjyno3N_K4_X9voQl5jZPrjViJShkg/");
    this.res.end();
  } 
